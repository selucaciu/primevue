...
const _hoisted_8 = /*#__PURE__*/createVNode("span", { class: "p-multiselect-filter-icon pi pi-search" }, null, -1 /* HOISTED */);
const _hoisted_9 = /*#__PURE__*/createVNode("span", { class: "p-multiselect-close-icon pi pi-times" }, null, -1 /* HOISTED */);
  ...
  return (openBlock(), createBlock("div", {
        ...
        renderSlot(_ctx.$slots, "value", {
          ...
          ($props.display === 'comma')
            ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                createTextVNode(toDisplayString($options.label || 'empty'), 1 /* TEXT */)
            ...
            : ($props.display === 'chip')
              ? (openBlock(), createBlock(Fragment, { key: 1 }, [
                  (openBlock(true), createBlock(Fragment, null, renderList($props.modelValue, (item) => {
                    return (openBlock(), createBlock("div", {
                      ...
                      renderSlot(_ctx.$slots, "chip", { value: item }, () => [
                        createVNode("span", _hoisted_3, toDisplayString($options.getLabelByValue(item)), 1 /* TEXT */)
                      ]),
                      (!$props.disabled)
                  ...
                  (!$props.modelValue || $props.modelValue.length === 0)
                    ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                        createTextVNode(toDisplayString($props.placeholder || 'empty'), 1 /* TEXT */)
                      ], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */))
                    : createCommentVNode("v-if", true)
                ], 64 /* STABLE_FRAGMENT */))
              : createCommentVNode("v-if", true)
    ...
    createVNode("div", _hoisted_4, [
      renderSlot(_ctx.$slots, "indicator", {}, () => [
        createVNode("span", { class: $options.dropdownIconClass }, null, 2 /* CLASS */)
      ])
    ]),
                          ...
                          ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList(items, (option, i) => {
                              return withDirectives((openBlock(), createBlock("li", {
                                ...
                                renderSlot(_ctx.$slots, "option", {
                                  ...
                                  createVNode("span", null, toDisplayString($options.getOptionLabel(option)), 1 /* TEXT */)
                                ])
                              ...
                              return (openBlock(), createBlock(Fragment, {
                                ...
                                createVNode("li", _hoisted_11, [
                                  renderSlot(_ctx.$slots, "optiongroup", {
                                    ...
                                    createTextVNode(toDisplayString($options.getOptionGroupLabel(optionGroup)), 1 /* TEXT */)
                                  ])
                                ]),
                        ...
                        ($data.filterValue && (!items || (items && items.length === 0)))
                          ? (openBlock(), createBlock("li", _hoisted_13, [
                              renderSlot(_ctx.$slots, "emptyfilter", {}, () => [
                                createTextVNode(toDisplayString($options.emptyFilterMessageText), 1 /* TEXT */)
                              ])
                            ]))
                          : ((!$props.options || ($props.options && $props.options.length === 0)))
                            ? (openBlock(), createBlock("li", _hoisted_14, [
                                renderSlot(_ctx.$slots, "empty", {}, () => [
                                  createTextVNode(toDisplayString($options.emptyMessageText), 1 /* TEXT */)
                                ])
                              ]))
                            : createCommentVNode("v-if", true)
                      ], 2 /* CLASS */)
...
script.__file = "src/components/multiselect/MultiSelect.vue";
