...
this.primevue.fileupload = (function (Button, ProgressBar, Message, utils, Ripple, vue) {
    ...
    const _hoisted_3 = /*#__PURE__*/vue.createVNode("span", { class: "p-button-icon p-button-icon-left pi pi-fw pi-plus" }, null, -1 /* HOISTED */);
        ...
        ? (vue.openBlock(), vue.createBlock("div", _hoisted_1, [
            vue.createVNode("div", _hoisted_2, [
              vue.withDirectives(vue.createVNode("span", {
                ...
                }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["multiple", "accept", "disabled"]),
                _hoisted_3,
                vue.createVNode("span", _hoisted_4, vue.toDisplayString($options.chooseButtonLabel), 1 /* TEXT */)
            ...
            vue.createVNode("div", {
              ...
              (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($data.messages, (msg) => {
                return (vue.openBlock(), vue.createBlock(_component_FileUploadMessage, {
                  ...
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(msg), 1 /* TEXT */)
                  ]),
                  _: 2 /* DYNAMIC */
                        ...
                        vue.createVNode("div", null, [
                          ($options.isImage(file))
                            ? (vue.openBlock(), vue.createBlock("img", {
                              ...
                              }, null, 8 /* PROPS */, ["alt", "src", "width"]))
                            : vue.createCommentVNode("v-if", true)
                        ]),
                        vue.createVNode("div", _hoisted_6, vue.toDisplayString(file.name), 1 /* TEXT */),
                        vue.createVNode("div", null, vue.toDisplayString($options.formatSize(file.size)), 1 /* TEXT */),
                        vue.createVNode("div", null, [
        ...
        : ($options.isBasic)
          ? (vue.openBlock(), vue.createBlock("div", _hoisted_8, [
              ...
              vue.withDirectives(vue.createVNode("span", {
                ...
                vue.createVNode("span", { class: $options.basicChooseButtonIconClass }, null, 2 /* CLASS */),
                vue.createVNode("span", _hoisted_9, vue.toDisplayString($options.basicChooseButtonLabel), 1 /* TEXT */),
                (!$options.hasFiles)
                  ? (vue.openBlock(), vue.createBlock("input", {
                    ...
                    }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["accept", "disabled", "multiple"]))
                  : vue.createCommentVNode("v-if", true)
              ], 38 /* CLASS, STYLE, HYDRATE_EVENTS */), [
                [_directive_ripple]
              ])
    ...
    script.__file = "src/components/fileupload/FileUpload.vue";
