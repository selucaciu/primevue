    ...
    ($options.paginatorTop)
      ? (vue.openBlock(), vue.createBlock(_component_DVPaginator, {
          ...
          (_ctx.$slots.paginatorend)
            ...
            : undefined
        ]), 1032 /* PROPS, DYNAMIC_SLOTS */, ["rows", "first", "totalRecords", "pageLinkSize", "template", "rowsPerPageOptions", "currentPageReportTemplate", "class", "alwaysShow"]))
      : vue.createCommentVNode("v-if", true),
...
script.__file = "src/components/dataview/DataView.vue";
