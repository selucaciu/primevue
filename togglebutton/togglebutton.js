...
this.primevue.togglebutton = (function (Ripple, vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.withDirectives((vue.openBlock(), vue.createBlock("div", {
        ...
        vue.createVNode("span", _hoisted_1, vue.toDisplayString($options.label), 1 /* TEXT */)
      ], 10 /* CLASS, PROPS */, ["aria-checked", "tabindex"])), [
        [_directive_ripple]
      ])
    }

    script.render = render;
    script.__file = "src/components/togglebutton/ToggleButton.vue";
