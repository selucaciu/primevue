  ...
  return (openBlock(), createBlock("li", { class: $options.containerClass }, [
    createVNode("div", {
      ...
      withDirectives(createVNode("button", {
        ...
        createVNode("span", { class: $options.toggleIcon }, null, 2 /* CLASS */)
      ], 512 /* NEED_PATCH */), [
        [_directive_ripple]
      ]),
      ...
      createVNode("span", { class: $options.icon }, null, 2 /* CLASS */),
      createVNode("span", _hoisted_2$1, [
        ($props.templates[$props.node.type]||$props.templates['default'])
          ...
          : (openBlock(), createBlock(Fragment, { key: 1 }, [
              createTextVNode(toDisplayString($options.label($props.node)), 1 /* TEXT */)
...
const _hoisted_3 = /*#__PURE__*/createVNode("span", { class: "p-tree-filter-icon pi pi-search" }, null, -1 /* HOISTED */);
const _hoisted_4 = {
