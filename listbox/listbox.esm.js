...
const _hoisted_4 = /*#__PURE__*/createVNode("span", { class: "p-listbox-filter-icon pi pi-search" }, null, -1 /* HOISTED */);
          ...
          createVNode("ul", {
            ...
            (!$props.optionGroupLabel)
              ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList(items, (option, i) => {
                  ...
                  ], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, ["tabindex", "onClick", "onKeydown", "aria-label", "aria-selected"])), [
                    [_directive_ripple]
                  ])
                }), 128 /* KEYED_FRAGMENT */))
...
script.__file = "src/components/listbox/Listbox.vue";
