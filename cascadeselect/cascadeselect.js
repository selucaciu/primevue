          ...
          return (vue.openBlock(), vue.createBlock("li", {
            ...
            vue.withDirectives(vue.createVNode("div", {
              ...
              ($props.templates['option'])
                ...
                : (vue.openBlock(), vue.createBlock("span", _hoisted_2$1, vue.toDisplayString($options.getOptionLabelToRender(option)), 1 /* TEXT */)),
      ...
      return (vue.openBlock(), vue.createBlock("div", {
        ...
        vue.createVNode("span", { class: $options.labelClass }, [
          vue.renderSlot(_ctx.$slots, "value", {
            ...
            vue.createTextVNode(vue.toDisplayString($options.label), 1 /* TEXT */)
          ])
        ], 2 /* CLASS */),
        vue.createVNode("div", {
