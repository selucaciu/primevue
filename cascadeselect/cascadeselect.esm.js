      ...
      return (openBlock(), createBlock("li", {
        ...
        withDirectives(createVNode("div", {
          ...
          ($props.templates['option'])
            ...
            : (openBlock(), createBlock("span", _hoisted_2$1, toDisplayString($options.getOptionLabelToRender(option)), 1 /* TEXT */)),
          ($options.isOptionGroup(option))
            ? (openBlock(), createBlock("span", _hoisted_3))
            : createCommentVNode("v-if", true)
        ], 40 /* PROPS, HYDRATE_EVENTS */, ["onClick", "onKeydown"]), [
          [_directive_ripple]
        ]),
        ($options.isOptionGroup(option) && $options.isOptionActive(option))
          ? (openBlock(), createBlock(_component_CascadeSelectSub, {
            ...
            }, null, 8 /* PROPS */, ["selectionPath", "options", "optionLabel", "optionValue", "level", "onOptionSelect", "onOptiongroupSelect", "optionGroupLabel", "optionGroupChildren", "parentActive", "dirty", "templates"]))
          : createCommentVNode("v-if", true)
      ], 2 /* CLASS */))
    }), 128 /* KEYED_FRAGMENT */))
  ]))
...
script$1.__file = "src/components/cascadeselect/CascadeSelectSub.vue";
  ...
  return (openBlock(), createBlock("div", {
    ...
    createVNode("span", { class: $options.labelClass }, [
      renderSlot(_ctx.$slots, "value", {
        ...
        createTextVNode(toDisplayString($options.label), 1 /* TEXT */)
      ])
    ], 2 /* CLASS */),
    createVNode("div", {
            ...
            ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", _hoisted_2, [
                  createVNode(_component_CascadeSelectSub, {
                    ...
                    dirty: $data.dirty,
                    root: true
                  }, null, 8 /* PROPS */, ["options", "selectionPath", "optionLabel", "optionValue", "templates", "optionGroupLabel", "optionGroupChildren", "onOptionSelect", "onOptiongroupSelect", "dirty"])
                ])
              ], 2 /* CLASS */))
            : createCommentVNode("v-if", true)
        ]),
...
script.__file = "src/components/cascadeselect/CascadeSelect.vue";
