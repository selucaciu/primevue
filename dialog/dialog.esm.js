...
const _hoisted_2 = /*#__PURE__*/createVNode("span", { class: "p-dialog-header-close-icon pi pi-times" }, null, -1 /* HOISTED */);
const _hoisted_3 = {
  key: 1,
                          ...
                          renderSlot(_ctx.$slots, "header", {}, () => [
                            ($props.header)
                              ? (openBlock(), createBlock("span", {
                                ...
                                }, toDisplayString($props.header), 9 /* TEXT, PROPS */, ["id"]))
                          ...
                          createVNode("div", _hoisted_1, [
                            ($props.maximizable)
                              ? withDirectives((openBlock(), createBlock("button", {
                                  ...
                                  createVNode("span", { class: $options.maximizeIconClass }, null, 2 /* CLASS */)
                                ], 512 /* NEED_PATCH */)), [
                                  [_directive_ripple]
                                ])
                              : createCommentVNode("v-if", true),
                    ...
                    ($props.footer || _ctx.$slots.footer)
                      ? (openBlock(), createBlock("div", _hoisted_3, [
                          renderSlot(_ctx.$slots, "footer", {}, () => [
                            createTextVNode(toDisplayString($props.footer), 1 /* TEXT */)
                          ])
                        ]))
                      : createCommentVNode("v-if", true)
