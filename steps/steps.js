                      ...
                      ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
                          (!$options.isItemDisabled(item))
                            ? (vue.openBlock(), vue.createBlock(_component_router_link, {
                                ...
                                default: vue.withCtx(({navigate, href, isActive, isExactActive}) => [
                                  vue.createVNode("a", {
                                    ...
                                    vue.createVNode("span", _hoisted_2, vue.toDisplayString(index + 1), 1 /* TEXT */),
                            ...
                            : (vue.openBlock(), vue.createBlock("span", {
                                ...
                                vue.createVNode("span", _hoisted_4, vue.toDisplayString(index + 1), 1 /* TEXT */),
                                vue.createVNode("span", _hoisted_5, vue.toDisplayString($options.label(item)), 1 /* TEXT */)
                              ], 2 /* CLASS */))
