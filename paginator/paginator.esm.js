...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("span", _hoisted_1$6, toDisplayString($options.text), 1 /* TEXT */))
}
...
const _hoisted_1$5 = /*#__PURE__*/createVNode("span", { class: "p-paginator-icon pi pi-angle-double-left" }, null, -1 /* HOISTED */);
...
const _hoisted_1$4 = /*#__PURE__*/createVNode("span", { class: "p-paginator-icon pi pi-angle-double-right" }, null, -1 /* HOISTED */);
...
const _hoisted_1$3 = /*#__PURE__*/createVNode("span", { class: "p-paginator-icon pi pi-angle-right" }, null, -1 /* HOISTED */);
  ...
  return (openBlock(), createBlock("span", _hoisted_1$2, [
    (openBlock(true), createBlock(Fragment, null, renderList($props.value, (pageLink) => {
      return withDirectives((openBlock(), createBlock("button", {
        ...
        createTextVNode(toDisplayString(pageLink), 1 /* TEXT */)
...
const _hoisted_1$1 = /*#__PURE__*/createVNode("span", { class: "p-paginator-icon pi pi-angle-left" }, null, -1 /* HOISTED */);
