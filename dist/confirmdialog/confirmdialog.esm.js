...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_CDialog, {
    ...
    footer: withCtx(() => [
      ...
      }, null, 8 /* PROPS */, ["label", "icon", "class", "autofocus"]),
      createVNode(_component_CDButton, {
    ...
    default: withCtx(() => [
      createVNode("i", { class: $options.iconClass }, null, 2 /* CLASS */),
      createVNode("span", _hoisted_1, toDisplayString($options.message), 1 /* TEXT */)
    ]),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["visible", "header", "blockScroll", "position", "breakpoints"]))
}

script.render = render;
script.__file = "src/components/confirmdialog/ConfirmDialog.vue";
