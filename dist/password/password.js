...
this.primevue.password = (function (utils, OverlayEventBus, InputText, vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (vue.openBlock(), vue.createBlock("div", {
        ...
        }, _ctx.$attrs), null, 16 /* FULL_PROPS */, ["class", "style", "type", "value", "onInput", "onFocus", "onBlur", "onKeyup"]),
        ($props.toggleMask)
              ...
              ($data.overlayVisible)
                ? (vue.openBlock(), vue.createBlock("div", {
                    ...
                    vue.renderSlot(_ctx.$slots, "content", {}, () => [
                      ...
                      vue.createVNode("div", _hoisted_2, vue.toDisplayString($data.infoText), 1 /* TEXT */)
                    ]),
    ...
    script.__file = "src/components/password/Password.vue";
