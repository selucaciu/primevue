...
const _hoisted_3$1 = /*#__PURE__*/createVNode("span", { class: "p-galleria-item-prev-icon pi pi-chevron-left" }, null, -1 /* HOISTED */);
const _hoisted_4$1 = { class: "p-galleria-item" };
const _hoisted_5 = /*#__PURE__*/createVNode("span", { class: "p-galleria-item-next-icon pi pi-chevron-right" }, null, -1 /* HOISTED */);
const _hoisted_6 = {
  key: 2,
    ...
    createVNode("div", _hoisted_2$1, [
      ($props.showThumbnailNavigators)
        ? withDirectives((openBlock(), createBlock("button", {
            ...
            createVNode("span", { class: $options.navBackwardIconClass }, null, 2 /* CLASS */)
          ], 10 /* CLASS, PROPS */, ["disabled"])), [
            [_directive_ripple]
          ])
        : createCommentVNode("v-if", true),
      ...
      ($props.showThumbnailNavigators)
        ? withDirectives((openBlock(), createBlock("button", {
            ...
            createVNode("span", { class: $options.navForwardIconClass }, null, 2 /* CLASS */)
          ], 10 /* CLASS, PROPS */, ["disabled"])), [
            [_directive_ripple]
          ])
        : createCommentVNode("v-if", true)
...
const _hoisted_1 = /*#__PURE__*/createVNode("span", { class: "p-galleria-close-icon pi pi-times" }, null, -1 /* HOISTED */);
const _hoisted_2 = {
  key: 1,
