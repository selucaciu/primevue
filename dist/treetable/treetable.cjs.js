  ...
  return (vue.openBlock(), vue.createBlock("td", {
    ...
    ($options.columnProp('expander'))
      ? vue.withDirectives((vue.openBlock(), vue.createBlock("button", {
          ...
          vue.createVNode("i", { class: $options.togglerIcon }, null, 2 /* CLASS */)
        ], 4 /* STYLE */)), [
          [_directive_ripple]
        ])
    ...
    ($props.column.children && $props.column.children.body)
      ...
      : (vue.openBlock(), vue.createBlock("span", _hoisted_2$2, vue.toDisplayString($options.resolveFieldData($props.node.data, $options.columnProp('field'))), 1 /* TEXT */))
  ], 6 /* CLASS, STYLE */))
}
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createBlock("th", {
    ...
    ($options.columnProp('header'))
      ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$1, vue.toDisplayString($options.columnProp('header')), 1 /* TEXT */))
      : vue.createCommentVNode("v-if", true),
    ...
    ($options.isMultiSorted())
      ? (vue.openBlock(), vue.createBlock("span", _hoisted_2$1, vue.toDisplayString($options.getMultiSortMetaIndex() + 1), 1 /* TEXT */))
      : vue.createCommentVNode("v-if", true)
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    (_ctx.$slots.footer)
      ...
      : vue.createCommentVNode("v-if", true),
    vue.createVNode("div", _hoisted_11, null, 512 /* NEED_PATCH */)
  ], 2 /* CLASS */))
}
