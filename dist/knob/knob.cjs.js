  ...
  return (vue.openBlock(), vue.createBlock("div", { class: $options.containerClass }, [
    (vue.openBlock(), vue.createBlock("svg", {
      ...
      vue.createVNode("path", {
        ...
        class: "p-knob-range"
      }, null, 8 /* PROPS */, ["d", "stroke-width", "stroke"]),
      vue.createVNode("path", {
        d: $options.valuePath,
        "stroke-width": $props.strokeWidth,
      ...
      ($props.showValue)
        ? (vue.openBlock(), vue.createBlock("text", {
            ...
            class: "p-knob-text"
          }, vue.toDisplayString($options.valueToDisplay), 9 /* TEXT, PROPS */, ["fill"]))
        : vue.createCommentVNode("v-if", true)
    ], 40 /* PROPS, HYDRATE_EVENTS */, ["width", "height"]))
  ], 2 /* CLASS */))
}
...
script.__file = "src/components/knob/Knob.vue";
