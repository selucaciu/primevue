...
this.primevue.virtualscroller = (function (vue) {
    ...
    script.__file = "src/components/virtualscroller/VirtualScroller.vue";
      ...
      return vue.withDirectives((vue.openBlock(), vue.createBlock("button", {
        ...
        vue.renderSlot(_ctx.$slots, "default", {}, () => [
          ...
          ($props.icon)
            ...
            : vue.createCommentVNode("v-if", true),
          vue.createVNode("span", _hoisted_1, vue.toDisplayString($props.label||' '), 1 /* TEXT */),
          ($props.badge)
            ? (vue.openBlock(), vue.createBlock("span", {
                key: 2,
                class: $options.badgeStyleClass
              }, vue.toDisplayString($props.badge), 3 /* TEXT, CLASS */))
            : vue.createCommentVNode("v-if", true)
        ])
...
this.primevue.inputtext = (function (vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, _ctx.$attrs), null, 16 /* FULL_PROPS */, ["value"]))
    }

    script.render = render;
    script.__file = "src/components/inputtext/InputText.vue";
...
this.primevue.inputnumber = (function (InputText, Button, vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (vue.openBlock(), vue.createBlock("span", {
        ...
        }), null, 16 /* FULL_PROPS */, ["class", "style", "value", "aria-valumin", "aria-valuemax", "onInput", "onKeydown", "onKeypress", "onPaste", "onClick", "onFocus", "onBlur"]),
        ($props.showButtons && $props.buttonLayout === 'stacked')
          ? (vue.openBlock(), vue.createBlock("span", _hoisted_1, [
              ...
              }), null, 16 /* FULL_PROPS */, ["class", "icon", "disabled"]),
              vue.createVNode(_component_INButton, vue.mergeProps({
    ...
    script.render = render;
    script.__file = "src/components/inputnumber/InputNumber.vue";
...
this.primevue.dropdown = (function (utils, OverlayEventBus, api, Ripple, VirtualScroller, vue) {
    ...
    const _hoisted_4 = /*#__PURE__*/vue.createVNode("span", { class: "p-dropdown-filter-icon pi pi-search" }, null, -1 /* HOISTED */);
      ...
      return (vue.openBlock(), vue.createBlock("div", {
        ...
        ($props.editable)
          ? (vue.openBlock(), vue.createBlock("input", {
              ...
              "aria-expanded": $data.overlayVisible
            }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["disabled", "placeholder", "value", "aria-expanded"]))
          : vue.createCommentVNode("v-if", true),
        (!$props.editable)
          ? (vue.openBlock(), vue.createBlock("span", {
              key: 1,
                              ...
                              ? (vue.openBlock(true), vue.createBlock(vue.Fragment, { key: 0 }, vue.renderList(items, (option, i) => {
                                  return vue.withDirectives((vue.openBlock(), vue.createBlock("li", {
                                    ...
                                    vue.renderSlot(_ctx.$slots, "option", {
                                      ...
                                      vue.createTextVNode(vue.toDisplayString($options.getOptionLabel(option)), 1 /* TEXT */)
                                    ])
                                  ], 10 /* CLASS, PROPS */, ["onClick", "aria-label", "aria-selected"])), [
                                    [_directive_ripple]
                                  ])
                                }), 128 /* KEYED_FRAGMENT */))
...
this.primevue.tree = (function (utils, Ripple, vue) {
    ...
    script$1.render = render$1;
    script$1.__file = "src/components/tree/TreeNode.vue";
    ...
    script.render = render;
    script.__file = "src/components/tree/Tree.vue";
              ...
              ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
                  ($props.item.to && !$options.disabled($props.item))
                    ? (vue.openBlock(), vue.createBlock(_component_router_link, {
                        ...
                        default: vue.withCtx(({navigate, href, isActive, isExactActive}) => [
                          vue.withDirectives(vue.createVNode("a", {
                            ...
                            vue.createVNode("span", _hoisted_1$1, vue.toDisplayString($options.label()), 1 /* TEXT */)
                    ...
                    : vue.withDirectives((vue.openBlock(), vue.createBlock("a", {
                        ...
                        vue.createVNode("span", _hoisted_2$1, vue.toDisplayString($options.label()), 1 /* TEXT */)
                              ...
                              (item.items)
                                ? (vue.openBlock(), vue.createBlock("li", _hoisted_2, [
                                    vue.renderSlot(_ctx.$slots, "item", { item: item }, () => [
                                      vue.createTextVNode(vue.toDisplayString($options.label(item)), 1 /* TEXT */)
                                    ])
                                  ]))
                                : vue.createCommentVNode("v-if", true),
