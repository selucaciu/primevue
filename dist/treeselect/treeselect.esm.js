...
const _hoisted_5 = /*#__PURE__*/createVNode("span", { class: "p-treeselect-trigger-icon pi pi-chevron-down" }, null, -1 /* HOISTED */);
const _hoisted_6 = {
  key: 0,
              ...
              ? (openBlock(), createBlock(Fragment, { key: 1 }, [
                  (openBlock(true), createBlock(Fragment, null, renderList($options.selectedNodes, (node) => {
                    return (openBlock(), createBlock("div", {
                      ...
                      createVNode("span", _hoisted_3, toDisplayString(node.label), 1 /* TEXT */)
                    ]))
                  }), 128 /* KEYED_FRAGMENT */)),
                  ($options.emptyValue)
                    ? (openBlock(), createBlock(Fragment, { key: 0 }, [
          ...
          ($data.overlayVisible)
            ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", {
                  ...
                  }, null, 8 /* PROPS */, ["value", "selectionMode", "onUpdate:selectionKeys", "selectionKeys", "expandedKeys", "onUpdate:expandedKeys", "metaKeySelection", "onNodeSelect", "onNodeUnselect"]),
...
script.__file = "src/components/treeselect/TreeSelect.vue";
