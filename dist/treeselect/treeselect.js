...
this.primevue.treeselect = (function (utils, OverlayEventBus, Tree, Ripple, vue) {
    ...
    const _hoisted_5 = /*#__PURE__*/vue.createVNode("span", { class: "p-treeselect-trigger-icon pi pi-chevron-down" }, null, -1 /* HOISTED */);
    const _hoisted_6 = {
      key: 0,
                  ...
                  ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 1 }, [
                      (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($options.selectedNodes, (node) => {
                        return (vue.openBlock(), vue.createBlock("div", {
                          ...
                          vue.createVNode("span", _hoisted_3, vue.toDisplayString(node.label), 1 /* TEXT */)
                        ]))
                      }), 128 /* KEYED_FRAGMENT */)),
                      ($options.emptyValue)
                        ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
