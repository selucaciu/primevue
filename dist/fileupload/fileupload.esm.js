...
const _hoisted_3 = /*#__PURE__*/createVNode("span", { class: "p-button-icon p-button-icon-left pi pi-fw pi-plus" }, null, -1 /* HOISTED */);
    ...
    ? (openBlock(), createBlock("div", _hoisted_1, [
        createVNode("div", _hoisted_2, [
          withDirectives(createVNode("span", {
            ...
            _hoisted_3,
            createVNode("span", _hoisted_4, toDisplayString($options.chooseButtonLabel), 1 /* TEXT */)
            ...
            ? (openBlock(), createBlock("div", _hoisted_5, [
                (openBlock(true), createBlock(Fragment, null, renderList($data.files, (file, index) => {
                  return (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", _hoisted_6, toDisplayString(file.name), 1 /* TEXT */),
                    createVNode("div", null, toDisplayString($options.formatSize(file.size)), 1 /* TEXT */),
                    createVNode("div", null, [
    ...
    : ($options.isBasic)
      ? (openBlock(), createBlock("div", _hoisted_8, [
          ...
          withDirectives(createVNode("span", {
            ...
            createVNode("span", { class: $options.basicChooseButtonIconClass }, null, 2 /* CLASS */),
            createVNode("span", _hoisted_9, toDisplayString($options.basicChooseButtonLabel), 1 /* TEXT */),
            (!$options.hasFiles)
