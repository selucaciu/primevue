...
const _hoisted_4 = /*#__PURE__*/createVNode("span", { class: "p-dropdown-filter-icon pi pi-search" }, null, -1 /* HOISTED */);
                          ...
                          ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList(items, (option, i) => {
                              return withDirectives((openBlock(), createBlock("li", {
                                ...
                                renderSlot(_ctx.$slots, "option", {
                                  ...
                                  createTextVNode(toDisplayString($options.getOptionLabel(option)), 1 /* TEXT */)
                                ])
